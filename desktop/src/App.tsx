...
export default function App() {
  ...
  const [baseUrl, setBaseUrl] = useState("http://homeassistant.local:8888");
    ...
    return (
      <main className="login">
        <div className="login__card">
          ...
          <label>
            Defender address
            <input value={baseUrl} onChange={(e) => setBaseUrl(e.target.value)} placeholder="http://homeassistant.local:8888" />
          </label>
          <label>
            Username
